                ...
                <div className="flex items-center justify-between h-16 sm:h-20 ">
                    ...
                    <nav className="hidden md:flex items-center gap-6 lg:gap-8 font-sans">
                        {NAVBAR_LINK.map((link) =>
                            link.comingSoon ? (
                                <ComingSoonTooltip key={link.name}>
                                    <span className="text-white/80 text-[14px] font-medium flex items-center gap-1 cursor-not-allowed">
                                        {link.name}
                                        {link.hasDropdown && (
                    ...
                    <div className="hidden md:flex items-center gap-5 lg:gap-6 font-sans">
                        <ComingSoonTooltip>
                            <span className="text-white/80 hover:text-white transition-colors text-[14px] font-medium flex items-center gap-1.5 cursor-not-allowed">
                        ...
                        <ComingSoonTooltip>
                            <span className="border border-white/45 hover:border-white hover:bg-white/10 rounded-full px-5 py-1.5 text-[14px] font-medium transition-all duration-200 cursor-not-allowed">
                                Sign In
                            </span>
                        </ComingSoonTooltip>
                    </div>
                ...
                <div className="md:hidden backdrop-blur-xl bg-gray-500/40 border-t border-white/5 py-4 px-6 flex flex-col gap-5 max-h-[calc(100vh-5rem)] overflow-y-auto shadow-2xl animate-in fade-in slide-in-from-top-4 duration-200 font-sans">
                    <nav className="flex flex-col gap-4">
                        {NAVBAR_LINK.map((link) =>
                            link.comingSoon ? (
                                <ComingSoonTooltip key={link.name}>
                                    <span className="text-white/80 py-1 text-base font-semibold flex items-center justify-between cursor-not-allowed">
                                        <span>{link.name}</span>
                                        {link.hasDropdown && (
                    ...
                    <div className="flex flex-col gap-4">
                        <ComingSoonTooltip>
                            <span className="text-white/80 transition-colors text-base font-semibold flex items-center gap-2 cursor-not-allowed">
                        ...
                        <ComingSoonTooltip>
                            <span className="border border-white/45 hover:border-white hover:bg-white/10 text-center rounded-full py-2.5 text-base font-semibold transition-all duration-200 w-full cursor-not-allowed">
                                Sign In
                            </span>
                        </ComingSoonTooltip>
                    </div>
